  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white- border rounded text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll'>
        ...
        <div className='max-sm:hidden sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 grid-flow-col py-3 px-6 border-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Payment</p>
          <p>Age</p>
...

        {
          appointments.map((item, index) => (
            <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-100' key={index}>
              ...
              {
                item.cancelled ? <p className='text-red-500 text-xs  font-medium'>Cancelled</p> : item.isCompleted ? <p className='text-green-600 text-xs  font-medium'>Completed</p> : <div className='flex'>
