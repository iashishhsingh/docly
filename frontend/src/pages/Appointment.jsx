    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2nsm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div>
              <p className="flex item-center gap-2 text-sm mt-1 text-gray-600">
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button onClick={bookAppointment} className="bg-primary px-14 py-3 text-white text-sm rounded-full my-6 transition-all duration-300 ease-in-out hover:scale-105 active:scale-95">
            Book an appointment
          </button>
        </div>
