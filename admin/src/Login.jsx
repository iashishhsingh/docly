    ...
    return (
        <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
            <div className='flex flex-col gap-3 m-auto items-start p-8 sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
                ...
                <button className='bg-primary text-white w-full py-2 rounded-md text-base  transition-all duration-300 ease-in-out hover:bg-primary-dark hover:scale-100 active:scale-95'>
                    Login
                </button>
