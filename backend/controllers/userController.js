...
// API to get user appointments for frontend to my-appointments page
...
const cancelAppointment = async (req, res) => {
  try {
    ...
    // Check whether appointment belongs to logged-in user
...
// API to make payment for appointment through Razorpay
...
// API to verify payment for appointment through Razorpay
...
const verifyPayment = async (req, res) => {
  try {
    ...
    if (orderInfo.status === "paid") {
      const appointmentId = orderInfo.receipt.replace("receipt_", "");
